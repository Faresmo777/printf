 ...
 *
 * @format: A string of characters that contains the format string
...
{
	int x, prints = 0, printed_chars = 0;
	...
	for (x = 0; format && format[x] != '\0'; x++)
	{
		...
		else
		{
			...
			++x;
			prints = handle_print(format, &x, list, buffer,
...
/**
 * print_buffer - a function that Prints contents of the buffer if it exists
